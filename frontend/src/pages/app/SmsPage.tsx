...
import { ChevronRight, Filter, Search, Loader2, X } from 'lucide-react';
        ...
        <DetailSection title="Decision">
          <div className="grid grid-cols-2 gap-3">
            <MobileCard padding="sm">
              ...
              <p className="mt-1 text-[17px] font-semibold tabular-nums text-white">{Math.round(detail.risk_score * 100)}%</p>
            </MobileCard>
            <MobileCard padding="sm">
              <p className="text-[13px] text-slate-500">Decision</p>
              <p className="mt-1 text-[17px] font-semibold capitalize text-white">{detail.decision}</p>
            </MobileCard>
          </div>
        </DetailSection>
      </div>
