...
const buttonClass =
  'flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl border border-white/[0.08] bg-surface-input px-4 py-3.5 text-sm font-medium text-white transition duration-200 hover:border-white/[0.14] hover:bg-white/[0.06] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50';
