...
from app.services.velocity import check_velocity, record_transaction
...
def process_transaction(
    ...
    *,
    ...
    velocity = check_velocity(str(user.id), amount_val)
    ...
    record_transaction(str(user.id), str(tx.id), amount_val)
