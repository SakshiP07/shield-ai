...
function wsUrl(): string {
  // In RN, use an absolute URL. __DEV__ replaces import.meta.env.DEV.
  if (__DEV__) {
    // For Android emulator use 10.0.2.2; for iOS simulator or real device, use your LAN IP
    return process.env.EXPO_PUBLIC_WS_URL ?? 'ws://10.0.2.2:8000/ws/alerts';
  }
  return process.env.EXPO_PUBLIC_WS_URL ?? 'wss://your-production-server.com/ws/alerts';
}
